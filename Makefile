...
MMO-Linux-Debug:
	 $(PROJECTBUILD) MMO Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

MMO-Linux-DebugGame:
	 $(PROJECTBUILD) MMO Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

MMO-Linux-Shipping:
	 $(PROJECTBUILD) MMO Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

MMO-Linux-Test:
	 $(PROJECTBUILD) MMO Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

MMO:
	 $(PROJECTBUILD) MMO Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

MMOClient-Linux-Debug:
	 $(BUILD) MMOClient Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

MMOClient-Linux-DebugGame:
	 $(BUILD) MMOClient Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

MMOClient-Linux-Shipping:
	 $(BUILD) MMOClient Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

MMOClient-Linux-Test:
	 $(BUILD) MMOClient Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

MMOClient:
	 $(BUILD) MMOClient Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

MMOEditor-Linux-Debug:
	 $(PROJECTBUILD) MMOEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

MMOEditor-Linux-DebugGame:
	 $(PROJECTBUILD) MMOEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

MMOEditor-Linux-Shipping:
	 $(PROJECTBUILD) MMOEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

MMOEditor-Linux-Test:
	 $(PROJECTBUILD) MMOEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

MMOEditor:
	 $(PROJECTBUILD) MMOEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

MMOServer-Linux-Debug:
	 $(BUILD) MMOServer Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

MMOServer-Linux-DebugGame:
	 $(BUILD) MMOServer Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

MMOServer-Linux-Shipping:
	 $(BUILD) MMOServer Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

MMOServer-Linux-Test:
	 $(BUILD) MMOServer Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

MMOServer:
	 $(BUILD) MMOServer Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
