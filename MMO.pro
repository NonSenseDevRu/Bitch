...
unrealRootPath=/home/user/Apps/UnrealEngine
MMORootPath=/home/user/Documents/Unreal Projects/mmo

gameProjectFile=/home/user/Documents/Unreal Projects/mmo/MMO.uproject
...
include(MMOSource.pri)
include(MMOHeader.pri)
include(MMOConfig.pri)
include(MMOIncludes.pri)
include(MMODefines.pri)
...
MMO-Linux-Debug.commands = $$build MMO Linux Debug  -project="\"$$gameProjectFile\"" $$args
MMO-Linux-DebugGame.commands = $$build MMO Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
MMO-Linux-Shipping.commands = $$build MMO Linux Shipping  -project="\"$$gameProjectFile\"" $$args
MMO-Linux-Test.commands = $$build MMO Linux Test  -project="\"$$gameProjectFile\"" $$args
MMO.commands = $$build MMO Linux Development  -project="\"$$gameProjectFile\"" $$args

MMOClient-Linux-Debug.commands = $$build MMOClient Linux Debug  -project="\"$$gameProjectFile\"" $$args
MMOClient-Linux-DebugGame.commands = $$build MMOClient Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
MMOClient-Linux-Shipping.commands = $$build MMOClient Linux Shipping  -project="\"$$gameProjectFile\"" $$args
MMOClient-Linux-Test.commands = $$build MMOClient Linux Test  -project="\"$$gameProjectFile\"" $$args
MMOClient.commands = $$build MMOClient Linux Development  -project="\"$$gameProjectFile\"" $$args

MMOEditor-Linux-Debug.commands = $$build MMOEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
MMOEditor-Linux-DebugGame.commands = $$build MMOEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
MMOEditor-Linux-Shipping.commands = $$build MMOEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
MMOEditor-Linux-Test.commands = $$build MMOEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
MMOEditor.commands = $$build MMOEditor Linux Development  -project="\"$$gameProjectFile\"" $$args

MMOServer-Linux-Debug.commands = $$build MMOServer Linux Debug  -project="\"$$gameProjectFile\"" $$args
MMOServer-Linux-DebugGame.commands = $$build MMOServer Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
MMOServer-Linux-Shipping.commands = $$build MMOServer Linux Shipping  -project="\"$$gameProjectFile\"" $$args
MMOServer-Linux-Test.commands = $$build MMOServer Linux Test  -project="\"$$gameProjectFile\"" $$args
MMOServer.commands = $$build MMOServer Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	MMO-Linux-Test \
	MMO \
	MMOClient-Linux-Debug \
	MMOClient-Linux-DebugGame \
	MMOClient-Linux-Shipping \
	MMOClient-Linux-Test \
	MMOClient \
	MMOEditor-Linux-Debug \
	MMOEditor-Linux-DebugGame \
	MMOEditor-Linux-Shipping \
	MMOEditor-Linux-Test \
	MMOEditor \
	MMOServer-Linux-Debug \
	MMOServer-Linux-DebugGame \
	MMOServer-Linux-Shipping \
	MMOServer-Linux-Test \
	MMOServer \
